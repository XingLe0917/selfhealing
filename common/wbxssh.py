...
class Wbxssh:
    ...
    def connect(self):
        ...
        try:
            self.client.connect("%s.webex.com" % self.host_name, port=self.ssh_port, username=self.login_user, password=self.login_pwd)
...
if __name__ == "__main__":
    host_name="frdbormt013"
    login_user="oracle"
    login_pwd="xmlk2hJ#8L"
